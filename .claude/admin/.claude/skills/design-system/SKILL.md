...
## Mission
Deliver implementation-ready design-system guidance for signal that can be applied consistently across dashboard web app interfaces.

## Brand
- Product/brand: signal
- URL: https://adminlte.io/wp-content/uploads/2026/02/signal-dashboard-nextjs-admin-dashboard.png
