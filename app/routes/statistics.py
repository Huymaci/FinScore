...
@statistics_bp.get('/spending-analysis')
@login_required
def spending_analysis():
    return validation_response(lambda: jsonify(service.spending_analysis(
        current_user.id, request.args.get('date_from'), request.args.get('date_to'))))
